...
const ValidateSecurity = (securityToBeAdded) => {
  ...
  const { Name, Price, Quantity } = securityToBeAdded;
  ...
  } else if (SecurityData.filter(i => i.Name == securityToBeAdded.Name).length > 0) {
